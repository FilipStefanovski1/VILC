document.addEventListener("DOMContentLoaded", () => {
    ...
    ttsBtn.addEventListener("click", () => {
        ...
        msg.text = document.querySelector(".about__content .section__description").textContent;
        msg.lang = "en-US";
        msg.rate = 1;
        msg.pitch = 1;
    ...
    sttBtn.addEventListener("click", () => {
        ...
        recognition.onresult = (event) => {
            ...
            speechResult = speechResult.replace(/\s/g, '').replace(/at/g, '@');
    ...
    document.querySelectorAll('p, h1, h2, h4').forEach(element => {
